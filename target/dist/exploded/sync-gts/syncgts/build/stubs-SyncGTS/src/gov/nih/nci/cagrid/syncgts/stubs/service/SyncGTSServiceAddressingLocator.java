/**
 * SyncGTSServiceAddressingLocator.java
 *
...
public class SyncGTSServiceAddressingLocator extends gov.nih.nci.cagrid.syncgts.stubs.service.SyncGTSServiceLocator implements gov.nih.nci.cagrid.syncgts.stubs.service.SyncGTSServiceAddressing {
    public gov.nih.nci.cagrid.syncgts.stubs.SyncGTSPortType getSyncGTSPortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	gov.nih.nci.cagrid.syncgts.stubs.SyncGTSPortType _stub = getSyncGTSPortTypePort(endpoint);
	if (_stub != null) {
