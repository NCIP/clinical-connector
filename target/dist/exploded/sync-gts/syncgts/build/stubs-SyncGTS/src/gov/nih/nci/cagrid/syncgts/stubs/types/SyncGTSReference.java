/**
 * SyncGTSReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.cagrid.syncgts.stubs.types;

public class SyncGTSReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public SyncGTSReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this SyncGTSReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this SyncGTSReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SyncGTSReference)) return false;
        SyncGTSReference other = (SyncGTSReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SyncGTSReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.nci.nih.gov/SyncGTS/types", ">SyncGTSReference"));
