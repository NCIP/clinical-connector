...
public class RemovedTrustedCAs  implements java.io.Serializable {
    private gov.nih.nci.cagrid.syncgts.bean.TrustedCA[] trustedCA;

    public RemovedTrustedCAs() {
    }
    ...
    /**
     * Gets the trustedCA value for this RemovedTrustedCAs.
     * 
     * @return trustedCA
     */
    ...
    /**
     * Sets the trustedCA value for this RemovedTrustedCAs.
     * 
     * @param trustedCA
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RemovedTrustedCAs)) return false;
        RemovedTrustedCAs other = (RemovedTrustedCAs) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RemovedTrustedCAs.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.nci.nih.gov/12/SyncGTS", "RemovedTrustedCAs"));
