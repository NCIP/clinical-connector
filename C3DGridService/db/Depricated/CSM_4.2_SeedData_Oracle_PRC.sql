...
INSERT INTO csm_group(group_name, group_desc, application_id) VALUES ('expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		csm_applicati_application__seq.currval);
INSERT INTO csm_group(group_name, group_desc, application_id) VALUES ('adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		csm_applicati_application__seq.currval);
