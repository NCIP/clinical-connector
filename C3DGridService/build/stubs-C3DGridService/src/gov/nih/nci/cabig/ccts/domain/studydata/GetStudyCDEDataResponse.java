...
public class GetStudyCDEDataResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the studyProtocol value for this GetStudyCDEDataResponse.
     * 
    ...
    /**
     * Sets the studyProtocol value for this GetStudyCDEDataResponse.
     * 
     * @param studyProtocol
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.studyData", "GetStudyCDEDataResponse"));
