...
/**
 * The intended course of action intended to achieve a diagnostic
 * or therapeutic result.
 * 
 * For example, surgeries, biopsies, radiation therapy, etc.
 */
public class PlannedProcedure  extends gov.nih.nci.cabig.ccts.domain.bridg.PlannedActivity  implements java.io.Serializable {
    /** Identifies the planned means or techniques for the procedure. 
 * 
 ...
 * etc. */
    ...
    /** A free text and coded representation of the PlannedProcedure. */
 ...
 * sites within the same organ system may be referenced. */
    ...
    /**
     * Gets the method value for this PlannedProcedure.
     * 
     * @return method Identifies the planned means or techniques for the procedure. 
 * 
 * For example, for a specimen collection, finger stick, veni puncture,
 * Abdominal/ ascites effusion, Biopsy, Bronchial alveolar lavage (BAL),
 * etc.
    ...
    /**
     * Sets the method value for this PlannedProcedure.
     * 
     * @param method Identifies the planned means or techniques for the procedure. 
 * 
 * For example, for a specimen collection, finger stick, veni puncture,
 * Abdominal/ ascites effusion, Biopsy, Bronchial alveolar lavage (BAL),
 * etc.
    ...
    /**
     * Gets the name value for this PlannedProcedure.
     * 
     * @return name A free text and coded representation of the PlannedProcedure.
     */
    ...
    /**
     * Sets the name value for this PlannedProcedure.
     * 
     * @param name A free text and coded representation of the PlannedProcedure.
     */
    ...
    /**
     * Gets the targetSite value for this PlannedProcedure.
     * 
 ...
 * sites within the same organ system may be referenced.
    ...
    /**
     * Sets the targetSite value for this PlannedProcedure.
     * 
 ...
 * sites within the same organ system may be referenced.
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PlannedProcedure)) return false;
        PlannedProcedure other = (PlannedProcedure) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PlannedProcedure.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "PlannedProcedure"));
