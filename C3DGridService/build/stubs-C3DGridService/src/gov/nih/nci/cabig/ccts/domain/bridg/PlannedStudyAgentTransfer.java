/**
 * PlannedStudyAgentTransfer.java
 *
...
/**
 * The intended action in which an authorized party at a designated
 * StudySite dispenses or receives a StudyAgent to/from a StudySubject.
 * 
 * For example, a StudySubject receives a bottle of pills.
 */
public class PlannedStudyAgentTransfer  extends gov.nih.nci.cabig.ccts.domain.bridg.PlannedAdministrativeActivity  implements java.io.Serializable {
 ...
 * units. */
    ...
    public PlannedStudyAgentTransfer() {
    }
    ...
    /**
     * Gets the originalQuantity value for this PlannedStudyAgentTransfer.
     * 
    ...
    /**
     * Sets the originalQuantity value for this PlannedStudyAgentTransfer.
     * 
    ...
    /**
     * Gets the quantity value for this PlannedStudyAgentTransfer.
     * 
 ...
 * units.
    ...
    /**
     * Sets the quantity value for this PlannedStudyAgentTransfer.
     * 
 ...
 * units.
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PlannedStudyAgentTransfer)) return false;
        PlannedStudyAgentTransfer other = (PlannedStudyAgentTransfer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PlannedStudyAgentTransfer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "PlannedStudyAgentTransfer"));
