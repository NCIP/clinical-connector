...
public class EnrollPatientRequest  implements java.io.Serializable {
    private gov.nih.nci.cabig.ccts.domain.bridg.StudyProtocol studyProtocol;

    public EnrollPatientRequest() {
    }
    ...
    /**
     * Gets the studyProtocol value for this EnrollPatientRequest.
     * 
    ...
    /**
     * Sets the studyProtocol value for this EnrollPatientRequest.
     * 
     * @param studyProtocol
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof EnrollPatientRequest)) return false;
        EnrollPatientRequest other = (EnrollPatientRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(EnrollPatientRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.enrollPatient", "EnrollPatientRequest"));
