...
/**
 * An object made to hold ManufacturedMaterial for the purpose of
 * transportation or protection of contents from loss or damage.
 * 
 * For example, a bottle that holds tablets.
 */
public class Container  extends gov.nih.nci.cabig.ccts.domain.bridg.ManufacturedMaterial  implements java.io.Serializable {
    /** Identifies the kind of storage medium.
 * 
 * For example, bottle, vial, box, blister pack, etc. */
     ...
     * 
     * @return type Identifies the kind of storage medium.
 * 
 * For example, bottle, vial, box, blister pack, etc.
     */
     ...
     * 
     * @param type Identifies the kind of storage medium.
 * 
 * For example, bottle, vial, box, blister pack, etc.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "Container"));
