/**
 * PlannedSpecimenCollection.java
 *
...
/**
 * The intended action of gathering samples that may be used for subsequent
 * analysis.  
 * 
 * For example, a blood draw.
 */
public class PlannedSpecimenCollection  extends gov.nih.nci.cabig.ccts.domain.bridg.PlannedProcedure  implements java.io.Serializable {
 ...
 * was obtained. */
    ...
    public PlannedSpecimenCollection() {
    }
    ...
    /**
     * Gets the fastingStatusIndicator value for this PlannedSpecimenCollection.
     * 
 ...
 * was obtained.
    ...
    /**
     * Sets the fastingStatusIndicator value for this PlannedSpecimenCollection.
     * 
 ...
 * was obtained.
    ...
    /**
     * Gets the specimen value for this PlannedSpecimenCollection.
     * 
     * @return specimen
     */
    ...
    /**
     * Sets the specimen value for this PlannedSpecimenCollection.
     * 
     * @param specimen
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PlannedSpecimenCollection)) return false;
        PlannedSpecimenCollection other = (PlannedSpecimenCollection) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PlannedSpecimenCollection.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "PlannedSpecimenCollection"));
