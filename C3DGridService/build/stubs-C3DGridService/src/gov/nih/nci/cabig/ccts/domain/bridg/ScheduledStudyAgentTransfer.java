/**
 * ScheduledStudyAgentTransfer.java
 *
...
/**
 * The action in which an authorized party at a designated StudySite
 * dispenses or receives a StudyAgent to/from a StudySubject at or during
 * a designated time.
 * 
 * For example, a StudySubject receives a bottle of pills.
 */
public class ScheduledStudyAgentTransfer  extends gov.nih.nci.cabig.ccts.domain.bridg.ScheduledAdministrativeActivity  implements java.io.Serializable {
 ...
 * units. */
    ...
    public ScheduledStudyAgentTransfer() {
    }
    ...
    /**
     * Gets the originalQuantity value for this ScheduledStudyAgentTransfer.
     * 
    ...
    /**
     * Sets the originalQuantity value for this ScheduledStudyAgentTransfer.
     * 
    ...
    /**
     * Gets the quantity value for this ScheduledStudyAgentTransfer.
     * 
 ...
 * units.
    ...
    /**
     * Sets the quantity value for this ScheduledStudyAgentTransfer.
     * 
 ...
 * units.
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ScheduledStudyAgentTransfer)) return false;
        ScheduledStudyAgentTransfer other = (ScheduledStudyAgentTransfer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ScheduledStudyAgentTransfer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "ScheduledStudyAgentTransfer"));
