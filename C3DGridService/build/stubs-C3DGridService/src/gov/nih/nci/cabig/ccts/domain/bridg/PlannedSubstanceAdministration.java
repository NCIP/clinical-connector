/**
 * PlannedSubstanceAdministration.java
 *
...
/**
 * The intended action of applying, dispensing or otherwise giving
 * medications or other substances to subjects.
 * 
 * For example, a study subject who receives methotrexate as part of
 * chemotherapy.
 */
public class PlannedSubstanceAdministration  extends gov.nih.nci.cabig.ccts.domain.bridg.PlannedActivity  implements java.io.Serializable {
 ...
 * For example, BID, TID, QID. */
    ...
    /** Text description of the intended schedule for the PlannedSubstanceAdministration.
 * 
 * 
 ...
 * For example, 10 miligrams, 2 mililiters, etc. */
    ...
    public PlannedSubstanceAdministration() {
    }
    ...
    /**
     * Gets the dose value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 5 mg, 20 mg/kg.
    ...
    /**
     * Sets the dose value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 5 mg, 20 mg/kg.
    ...
    /**
     * Gets the doseDescription value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 200-400.
    ...
    /**
     * Sets the doseDescription value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 200-400.
    ...
    /**
     * Gets the doseForm value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, tablet, capsule, ointment, gel, etc.
    ...
    /**
     * Sets the doseForm value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, tablet, capsule, ointment, gel, etc.
    ...
    /**
     * Gets the doseFrequency value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, BID, TID, QID.
    ...
    /**
     * Sets the doseFrequency value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, BID, TID, QID.
    ...
    /**
     * Gets the doseRegimen value for this PlannedSubstanceAdministration.
     * 
     * @return doseRegimen Text description of the intended schedule for the PlannedSubstanceAdministration.
 * 
 * 
 * For example, 2 weeks on, 2 weeks off.  
 * 
 ...
 * use cases arise.
    ...
    /**
     * Sets the doseRegimen value for this PlannedSubstanceAdministration.
     * 
     * @param doseRegimen Text description of the intended schedule for the PlannedSubstanceAdministration.
 * 
 * 
 * For example, 2 weeks on, 2 weeks off.  
 * 
 ...
 * use cases arise.
    ...
    /**
     * Gets the doseTotal value for this PlannedSubstanceAdministration.
     * 
    ...
    /**
     * Sets the doseTotal value for this PlannedSubstanceAdministration.
     * 
    ...
    /**
     * Gets the locationOfDoseAdministration value for this PlannedSubstanceAdministration.
     * 
 ...
 * in this attribute.
    ...
    /**
     * Sets the locationOfDoseAdministration value for this PlannedSubstanceAdministration.
     * 
 ...
 * in this attribute.
    ...
    /**
     * Gets the routeOfAdministration value for this PlannedSubstanceAdministration.
     * 
 ...
 * etc.
    ...
    /**
     * Sets the routeOfAdministration value for this PlannedSubstanceAdministration.
     * 
 ...
 * etc.
    ...
    /**
     * Gets the treatment value for this PlannedSubstanceAdministration.
     * 
 ...
 * and textual representation of the treatment.
    ...
    /**
     * Sets the treatment value for this PlannedSubstanceAdministration.
     * 
 ...
 * and textual representation of the treatment.
    ...
    /**
     * Gets the treatmentVehicle value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, saline, corn oil, glycerin, syrup, etc.
    ...
    /**
     * Sets the treatmentVehicle value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, saline, corn oil, glycerin, syrup, etc.
    ...
    /**
     * Gets the treatmentVehicleAmount value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 10 miligrams, 2 mililiters, etc.
    ...
    /**
     * Sets the treatmentVehicleAmount value for this PlannedSubstanceAdministration.
     * 
 ...
 * For example, 10 miligrams, 2 mililiters, etc.
    ...
    /**
     * Gets the studyAgent value for this PlannedSubstanceAdministration.
     * 
     * @return studyAgent
     */
    ...
    /**
     * Sets the studyAgent value for this PlannedSubstanceAdministration.
     * 
     * @param studyAgent
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PlannedSubstanceAdministration)) return false;
        PlannedSubstanceAdministration other = (PlannedSubstanceAdministration) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PlannedSubstanceAdministration.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://ccts.cabig/1.0/gov.nih.nci.cabig.ccts.domain.bridg", "PlannedSubstanceAdministration"));
