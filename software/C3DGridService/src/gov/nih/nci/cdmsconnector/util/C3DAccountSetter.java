...
public class C3DAccountSetter {

	private final static Logger log = Logger
	.getLogger(C3DAccountSetter.class.getName());
	
	public C3DAccountSetter(String UName, String PWord)
	throws Exception {
	...
	public static void main(String args[]){
		try{
			C3DAccountSetter se = new C3DAccountSetter(null, null);
