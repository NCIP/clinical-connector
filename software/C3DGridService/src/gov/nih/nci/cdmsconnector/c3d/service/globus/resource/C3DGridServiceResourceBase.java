...
import gov.nih.nci.cdmsconnector.c3d.service.C3DGridServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class C3DGridServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(C3DGridServiceResourceBase.class);

	private C3DGridServiceResourceConfiguration configuration;
    ...
    public C3DGridServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((C3DGridServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(C3DGridServiceConstants.SERVICEMETADATA);
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((C3DGridServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
