 ...
 * 
 */
public class C3DGridServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://c3d.cdmsconnector.nci.nih.gov/C3DGridService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public C3DGridServiceAuthorization() {
	}
	...
	public void authorizeIsValidStudy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
