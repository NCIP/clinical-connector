 ...
 */
package gov.nih.nci.clinicalconnector.service.globus.resource;
...
import gov.nih.nci.clinicalconnector.common.ClinicalConnectorConstants;
import gov.nih.nci.clinicalconnector.stubs.ClinicalConnectorResourceProperties;
import gov.nih.nci.clinicalconnector.service.ClinicalConnectorConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class ClinicalConnectorResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ClinicalConnectorResourceBase.class);

	private ClinicalConnectorResourceConfiguration configuration;
    ...
    public ClinicalConnectorResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((ClinicalConnectorResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(ClinicalConnectorConstants.SERVICEMETADATA);
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((ClinicalConnectorResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
