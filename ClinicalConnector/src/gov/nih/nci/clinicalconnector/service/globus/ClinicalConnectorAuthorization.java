 ...
 * 
 */
public class ClinicalConnectorAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://gov.nci.nih.clinicalconnector/ClinicalConnector";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ClinicalConnectorAuthorization() {
	}
	...
	public void authorizeRegisterSubject(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("registerSubject")){
			authorizeRegisterSubject(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
