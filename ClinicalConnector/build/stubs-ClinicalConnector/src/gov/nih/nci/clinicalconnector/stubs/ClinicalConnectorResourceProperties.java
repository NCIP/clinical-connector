/**
 * ClinicalConnectorResourceProperties.java
 *
...
public class ClinicalConnectorResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public ClinicalConnectorResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this ClinicalConnectorResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this ClinicalConnectorResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ClinicalConnectorResourceProperties)) return false;
        ClinicalConnectorResourceProperties other = (ClinicalConnectorResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ClinicalConnectorResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gov.nci.nih.clinicalconnector/ClinicalConnector", ">ClinicalConnectorResourceProperties"));
