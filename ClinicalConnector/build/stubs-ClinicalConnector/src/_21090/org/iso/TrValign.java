...
public class TrValign implements java.io.Serializable {
    ...
    // Constructor
    protected TrValign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static TrValign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>tr>valign"));
    }
    /**
