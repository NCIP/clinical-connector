...
public class TdAlign implements java.io.Serializable {
    ...
    // Constructor
    protected TdAlign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static TdAlign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>td>align"));
    }
    /**
