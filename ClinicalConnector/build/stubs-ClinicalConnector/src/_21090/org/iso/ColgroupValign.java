...
public class ColgroupValign implements java.io.Serializable {
    ...
    // Constructor
    protected ColgroupValign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static ColgroupValign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>colgroup>valign"));
    }
    /**
