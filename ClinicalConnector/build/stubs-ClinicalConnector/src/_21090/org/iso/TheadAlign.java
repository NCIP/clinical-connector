...
public class TheadAlign implements java.io.Serializable {
    ...
    // Constructor
    protected TheadAlign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static TheadAlign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>thead>align"));
    }
    /**
