...
public class ColAlign implements java.io.Serializable {
    ...
    // Constructor
    protected ColAlign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static ColAlign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>col>align"));
    }
    /**
