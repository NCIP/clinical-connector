...
public class TheadValign implements java.io.Serializable {
    ...
    // Constructor
    protected TheadValign(org.apache.axis.types.NMToken value) {
        _value_ = value;
    ...
    public static TheadValign fromValue(org.apache.axis.types.NMToken value)
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", ">>thead>valign"));
    }
    /**
