...
public class IVL_MO  extends _21090.org.iso.QSET_MO  implements java.io.Serializable {
    private _21090.org.iso.MO low;
    private _21090.org.iso.MO high;
    ...
    public IVL_MO(
           _21090.org.iso.MO high,
           java.lang.Boolean highClosed,
           _21090.org.iso.MO low,
    ...
    /**
     * Gets the low value for this IVL_MO.
     * 
     * @return low
     */
    public _21090.org.iso.MO getLow() {
        return low;
    }


    /**
     * Sets the low value for this IVL_MO.
     * 
     * @param low
     */
    public void setLow(_21090.org.iso.MO low) {
        this.low = low;
    }


    /**
     * Gets the high value for this IVL_MO.
     * 
     * @return high
     */
    public _21090.org.iso.MO getHigh() {
        return high;
    }


    /**
     * Sets the high value for this IVL_MO.
     * 
     * @param high
     */
    public void setHigh(_21090.org.iso.MO high) {
        this.high = high;
    }


    /**
     * Gets the width value for this IVL_MO.
     * 
     * @return width
     */
    ...
    /**
     * Sets the width value for this IVL_MO.
     * 
     * @param width
     */
    ...
    /**
     * Gets the lowClosed value for this IVL_MO.
     * 
     * @return lowClosed
     */
    ...
    /**
     * Sets the lowClosed value for this IVL_MO.
     * 
     * @param lowClosed
     */
    ...
    /**
     * Gets the highClosed value for this IVL_MO.
     * 
     * @return highClosed
     */
    ...
    /**
     * Sets the highClosed value for this IVL_MO.
     * 
     * @param highClosed
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof IVL_MO)) return false;
        IVL_MO other = (IVL_MO) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(IVL_MO.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", "IVL_MO"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("uri:iso.org:21090", "MO"));
